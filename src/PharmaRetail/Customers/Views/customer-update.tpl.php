<?php
  ...
  if(isset($submitted_data['refNumber']) && $submitted_data['refNumber'] !== '' ) {
    $reg_no = $submitted_data['refNumber'];
  } else {
    $reg_no = '';
  }
        ...
        <form class="form-validate form-horizontal" method="POST">
          ...
          <div class="form-group">
            ...
            <?php else: ?>
              ...
              <input type="hidden" id="ageCategory" name="ageCategory" value="<?php echo $age_category ?>" />
            <?php endif; ?>
