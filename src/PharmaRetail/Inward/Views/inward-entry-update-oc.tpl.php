  ...
  <div class="col-lg-12"> 
    <section class="panelBox">
      <div class="panelBody">
        ...
        <form class="form-validate form-horizontal" method="POST" id="inwardEntryForm">
          <div class="panel">
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover item-detail-table font12" id="purchaseTable">
              ...
              <?php
                ...
                for($i=1;$i<=$total_item_rows;$i++):
                  ...
                  if($discount_percent>0) {
                    $tax_amount = round( ($item_amount-($item_amount*$discount_percent/100))*$tax_percent/100, 2);
                  } else {
              ...
              ?>
                <tr class="purchaseItemRow">
                  ...
                  <input 
                    ...
                    <?php echo $disabled ?>
                  />
                    <input type="hidden" name="batchNo[]" value="<?php echo $batch_no ?>" />
                    <input type="hidden" name="expDate[]" value="<?php echo $exp_date ?>" />
                </tr>
              <?php 
                endfor;

                $items_total = $form_data['billAmount'];
              ...
              ?>
                ...
                <tr>
                  <td style="vertical-align:middle;" colspan="6" align="right">(-) Discount (in %)</td>
                  ...
                  <td style="vertical-align:middle;text-align:right;" id="inwDiscountValue"><?php echo $discount_amount ?></td>                
                </tr>
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;" colspan="7" align="right">Items total (after discount)</td>
                ...
                <?php if( is_array($taxes_raw) && count($taxes_raw)>0 ): ?>
                  ...
                  ?>
                    <tr>
                      <td colspan="7" align="right">(+) <?php echo $tax_label ?></td>
                      <td align="right" id="taxAmount_<?php echo $tax_code ?>" class="taxAmounts"><?php echo round($tax_amount,2) ?></td>
                    </tr>
                    <input type="hidden" value="<?php echo $tax_percent ?>" id="<?php echo $tax_code ?>" class="taxPercents" />
                  <?php endforeach; ?>
                <?php endif;?>
                <tr>
                  <td style="vertical-align:middle;" colspan="7" align="right">(+) Other taxes</td>
                ...
                <tr>
                  <td style="vertical-align:middle;" colspan="7" align="right">(+) Freight / Shipping charges</td>
                  <td style="vertical-align:middle;text-align:right;">
                    <input
                      type = "text"
                      class="form-control noEnterKey"
                ...
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;" colspan="7" align="right">Grand total</td>
                  <td style="vertical-align:middle;text-align:right;" id="inwTotalAmount"><?php echo round($grand_total,2) ?></td>
                </tr>
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;" colspan="7" align="right">(+/-) Adjustments</td>
                  <td style="vertical-align:middle;text-align:right;">
                    <input
                      type = "text"
                      class="form-control noEnterKey"
                ...
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;" colspan="7" align="right">Round off</td>
                  <td style="vertical-align:middle;text-align:right;" id="roundOff"><?php echo $round_off ?></td>
                </tr>                
                <tr>
                  <td style="vertical-align:middle;font-weight:bold;font-size:14px;" colspan="7" align="right">Total amount</td>
                ...
                <tr>
                  ...
                  <td style="vertical-align:middle;text-align:right;" colspan="7">
                    <textarea
                      class="form-control noEnterKey"
                      rows="3"
                      cols="100"
