<?php
  ...
  if(isset($form_data['supplierState']) && ((int)$form_data['supplierState'] === (int)$client_business_state)) {
    $supply_type = 'inter';
  } else {
    $supply_type = 'intra';
  }
  if(isset($form_data['supplierState'])) {
    $supplier_state = $form_data['supplierState'];
  } else {
    $supplier_state = 0;
  }
