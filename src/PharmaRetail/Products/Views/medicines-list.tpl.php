      ...
      <div class="panelBody">
		...
		<div class="filters-block">
          ...
          <div class="col-sm-12 col-md-1 col-lg-1 text-right">
				  ...
				  <div class="col-sm-12 col-md-2 col-lg-2">
					 <input placeholder="Composition" type="text" name="composition" id="composition" class="form-control" value="<?php echo $composition ?>">
				  </div>
				  <div class="col-sm-12 col-md-2 col-lg-2">
          ...
          <table class="table table-striped table-hover" id="itemnames">
            <thead>
              <tr class="font12">
                ...
                <th width="4%" class="text-left">Medicine code</th>                
                <th width="30%" class="text-left">Medicine name</th>
                ...
                <th width="20%" class="text-center">Composition</th>
              </tr>
            </thead>
            <tbody>
              <?php 
              ...
              ?>
                  <tr class="text-uppercase text-right font11">
                    ...
                    <td class="text-left"><?php echo $compName ?></td>
                  </tr>
            <?php
              $cntr++;
              endforeach; 
