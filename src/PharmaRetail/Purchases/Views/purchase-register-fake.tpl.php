<?php
  ...
  $pagination_url = '/purchase/list-apex';
?>
            ...
            <tbody>
              <?php 
                ...
                foreach($purchases as $purchase_details):
                  ...
                  if($purchase_details['netPay'] > 0) {
                    $fake_amount = round( $purchase_details['netPay']*15/100, 0);
                  } else {
                    $fake_amount = 0;
                  }

                  $po_amount = $purchase_details['netPay'] + $fake_amount;
