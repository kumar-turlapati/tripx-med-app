<?php
  use Atawa\Utilities;
  if(isset($submitted_data['taxName'])) {
    $taxName = $submitted_data['taxName'];
  } else {
    $taxName = '';
  }
...
<div class="row">
  <div class="col-lg-12"> 
    ...
    <!-- Panel starts -->
    <section class="panel">
      <h2 class="hdg-reports text-center">Add Tax Rate</h2>
        ...
        <div class="global-links actionButtons clearfix">
          <div class="pull-right text-right">
            <a href="/taxes/list" class="btn btn-default">
              <i class="fa fa-book"></i> Taxes List 
            </a> 
          </div>
        </div>
        <!-- Right links ends -->         
        ...
        <form class="form-validate form-horizontal" method="POST">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 m-bot15">
              ...
              <input 
                type="text" class="form-control" name="taxPercent" id="taxes_taxPercent" 
                value="<?php echo $taxPercent ?>"
              >
